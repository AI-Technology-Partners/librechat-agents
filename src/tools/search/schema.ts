...
export const languageSchema = {
  type: 'string',
  description:
    'Language for search results. Use values like "all", "en", "fr", or other SearXNG-supported language codes.',
} as const;

export const enginesSchema = {
  type: 'string',
  description:
    'Comma-separated SearXNG engines to use, for example "google,bing,duckduckgo".',
} as const;
// AITP: ADD - END
